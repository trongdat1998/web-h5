...
class Agreement extends React.Component {
  constructor() {
    ...
    this.state = {
      title: {
        "zh-cn": "点卡套餐服务协议",
        "en-us": "Point Card Package Services Agreement"
      },
      content: {
        "zh-cn": `
<br/>【首部及导言】
<br/>欢迎您使用点卡套餐服务！
<br/>为使用点卡套餐服务（简称为：本服务），您应当阅读并遵守《点卡套餐服务协议》（简称为：本协议）。请您务必审慎阅读、充分理解各条款内容，特别是免除或限制责任的相应条款，以及开通或使用某项服务的单独协议，并选择接受或不接受。
...
<br/>本网站可能会根据不同的产品及服务类型，推出不同的点卡套餐服务。目前，本网站提供购买点卡送HT、默认使用点卡支付币币交易手续费、点卡转让等服务。同时，本网站也可能会根据用户的需求、产品及服务类型的变化等，对现有服务种类进行调整以及不断推出新的服务种类。本网站也可能会在不同时间推出具体不同的服务内容，以不断完善、优化本服务。具体服务种类、服务内容、服务规则以相关服务页面公布、实际提供的内容为准。您可以自行根据需要选择相应服务。
<br/>
<br/>三、特别声明
