...
class OptionGuest extends React.Component {
  ...
  getSteps() {
    return [lang("了解规则"), lang("通过测试"), lang("开通权限")];
  }
  ...
  getStepContent(step) {
    ...
    switch (step) {
      case 0:
        return [
          <div>
            <h1 className={c.title}>{lang("开通交易")}</h1>
            <p className={c.tip}>
              {lang(
          ...
          <div className={c.knowledge}>
            <div>
              ...
              <Table>
                <TableBody>
                  <TableRow>
                    <TableCell width={80} style={{ padding: "4px 8px" }}>
                      {lang("future.tab.1")}
                    </TableCell>
      ...
      case 1:
        return [
          <div>
            <h1 className={c.title}>{lang("永续合约测试")}</h1>
            <p className={c.tip}>
              {lang(
                "亲爱的用户，为了保证您接下来更好的控制资金风险，您需要了解以下规则，才能开通交易。"
              )}
  ...
  finish() {
    this.props.dispatch({
      type: "future/openOption",
    });
  }

  componentDidMount() {
    this.props.dispatch({
      type: "future/fetchIfOpenedOption",
    });
  }
      ...
      <div className={c.container}>
        ...
        >
          ...
          <Button
            ...
            className={c.button}
          >
            {activeStep === 0 ? lang("开始交易") : null}
            {activeStep === 1 ? lang("提交答案") : null}
            {activeStep === 2 ? lang("开始交易") : null}
          </Button>
        </div>
        {activeStep === 2 &&
        this.props.index_config &&
